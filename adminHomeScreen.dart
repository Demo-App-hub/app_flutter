...
import 'package:demo_app_01_02/BorrowingsScreen.dart';
import 'package:demo_app_01_02/ReturnedBorrowingsScreen.dart';
...
import 'package:demo_app_01_02/infoDeviceAdmin.dart';
import 'package:demo_app_01_02/infoDeviceUser.dart';
import 'package:demo_app_01_02/listAccount.dart';
import 'package:demo_app_01_02/listClass.dart';
...
import 'package:demo_app_01_02/senFileCsvToEmail.dart';
...
class AdminHomeScreen extends StatefulWidget {
  ...
  AdminHomeScreen(this.authManager, {required this.username});
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ListAccount()),
                );
              },
            ),
            ListTile(
            ...
            ListTile(
              title: const Text('Quản lý mượn thiết bị'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => BorrowingsScreen()),
                );
              },
            ),
            ListTile(
              title: const Text('Quản lý trả thiết bị'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ReturnBorrwingScreen()),
                );
              },
            ),
            ListTile(
            ...
            ListTile(
              title: const Text('Quản lý loại thiết bị'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => CategoryDataScreen()),
                );
              },
            ),
            ListTile(
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ListDeviceClassAdmin(
        ...
        onPressed: () async {
          ...
          if (await check) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => EquipmentInfoScreenAdmin(
